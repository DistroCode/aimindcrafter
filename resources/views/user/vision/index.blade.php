								...
								<div class="flex" id="templates-panel">			
									<div class="row chat-model-box pl-5 pr-5 pt-2 pb-2">
										...
										@foreach ($models as $model)
											...
											@elseif (trim($model) == 'claude-3')
												<div class="col-md-4 col-sm-12">
													<input type="radio" id="control_04" name="model" onclick="handleClick(this);" value="claude-3">
													<label for="control_04">
														...
														{{-- <a href="{{ route('user.plans') }}" class="fs-12 action-button">{{ __('Upgrade Plan') }}</a> --}}
													</label>
												</div>
											@else
